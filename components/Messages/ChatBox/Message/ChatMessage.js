    ...
    return (
        <div className='w-full'>
            <div className={`mb-3 max-w-[150px] md:max-w-[300px] ${self ? "ml-auto" : ""}`}>
                <div className={`relative group flex flex-col gap-4 p-3  rounded-xl break-all ${self ? "rounded-br-sm bg-green-500/20 text-gray-700" : "rounded-bl-sm bg-slate-400/20 text-gray-600"}`}  >
                    {chat}
