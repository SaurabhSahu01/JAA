...
function FeedUpload() {
    ...
    return (
        <div className='w-full flex justify-center items-center gap-3 mt-2'>
            ...
            <div className='md:w-full xs:w-9/12 sm:p-2 xs:p-1 rounded-full bg-gray-200 flex justify-center items-center border-[1px] border-black cursor-pointer tracking-wider'>
                Share a post
            </div>
        </div>
    )
