    ...
    return (
        <div className={`z-10 h-screen hover:shadow-2xl  fixed bg-slate-100 left-0 top-0 md:w-[6rem] ${open ? 'w-[6rem]' : 'w-[3rem]'}`}>
            <ul className='h-screen flex flex-col justify-center gap-8 md:justify-between items-center py-5 px-2'>
                ...
                <Link href="/adminpanel" className={`flex flex-col justify-center items-center gap-1 select-none cursor-pointer ${router.pathname === '/adminpanel' ? ' text-gray-600' : 'text-black'}`}>
                ...
                <Link href="/adminpanel/users" className={`flex flex-col justify-center items-center gap-1 select-none cursor-pointer ${router.pathname === '/adminpanel/users' ? ' text-gray-600' : 'text-black'}`}>
                ...
                <Link href="/adminpanel/posts" className={`flex flex-col justify-center items-center gap-1 select-none cursor-pointer ${router.pathname.includes('/adminpanel/posts') ? ' text-gray-600' : 'text-black'}`}>
                ...
                <Link href="/adminpanel/messages" className={`mb-auto flex flex-col justify-center items-center gap-1 select-none cursor-pointer ${router.pathname === '/adminpanel/messages' ? ' text-gray-600' : 'text-black'}`}>
