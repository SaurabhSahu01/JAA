...
const ChatFooter = () => {
  ...
  return (
    ...
    <div className=" absolute w-[100px] h-[100px] bottom-16 left-0 bg-c1 p-2 rounded-md">
        ...
        <div className=" w-6 h-6 rounded-full bg-red-500 flex justify-center items-center absolute -right-2 -top-2 cursor-pointer" onClick={()=>{
          setAttachment(null);
      ...
      {/* imoji picker */}
        {/* <Icon
          size="large"
          className={``}
          icon={<HiOutlineEmojiHappy size={20} className=" text-c3" />}
