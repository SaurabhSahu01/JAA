          ...
          <div className='w-full md:w-6/12 bg-[#1B2D56] rounded-md'>
            ...
            <div className='flex flex-col content-start m-10 '>
              <div className='flex my-4'>
                ...
                <a className='mx-3 font-light text-sm' href="tel:+91564564"><span>+91-85494891</span></a>
                <a className='mx-3 font-light text-sm' href="tel:+918946542"><span>+91-856146548</span></a>
              </div>
              ...
              <div className='flex my-4'>
                ...
                <a className='mx-3 font-light text-sm' href="mailto: demo@gmail.com"><span>md.abcdf@gmail.com</span></a>
              </div>
              ...
              <div className='w-full flex my-4'>
                ...
                <span className='w-fit mx-3 font-light text-sm'>us bro us,
                  jnu bro jnu,
                </span>
              </div>
            </div>
            ...
            <div className="flex h-1/3 mt-4 space-x-6 justify-start items-center sm:mt-0 p-10">
              <Link href="https://m.facebook.com" className="text-slate-200 hover:text-gray-900 ">
              ...
              <Link href="https://instagram.com" className="text-slate-200 hover:text-gray-900">
              ...
              <Link href="https://twitter.com" className="text-slate-200 hover:text-gray-900 ">
