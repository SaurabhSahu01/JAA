...
const Profile = () => {
    ...
    return (
        <div className=' relative m-6 mx-auto p-4 bg-white rounded-lg flex flex-col items-center justify-center z-0 w-[95%] md:w-[65%]'>
            ...
            <div className='flex flex-col items-center mt-4 p-3'>
                ...
                <table className='flex flex-col w-fit bg-[#e4eafb] rounded-lg p-4 mt-2'>
