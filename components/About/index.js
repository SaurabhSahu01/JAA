  ...
  return (
    <>
        <div className='rounded bg-white w-11/12 mx-auto my-10 self-center p-6'>
          ...
          The JNU Alumni Association (JAA) is a forum that can help connect you to your alma mater.
          JAA is dedicated to bringing together the alumni on a common platform and building a channel 
          of personal and professional support for members through &aposself-help&apos offered from within the 
          ...
          alumni as important stakeholders in JNU&aposs continuing quest to provide quality and meaningful
